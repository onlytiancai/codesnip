...
QUnit.test("包含分支语句的函数定义与调用:showmax(a, b)", function(assert) {
    var input = 'function showmax(a, b)\n' +
        '  if a > b then\n' +
        '    print a\n' +
        '  end if\n' +
        '  if b > a then\n' +
