...
#0  _IO_vfprintf_internal (s=0x0, format=0x560a28c3476a "%s\n", ap=ap@entry=0x7fff74e66260) at vfprintf.c:1283
...
- [Linux环境下段错误的产生原因及调试方法小结](https://www.cnblogs.com/panfeng412/archive/2011/11/06/segmentation-fault-in-linux.html)
