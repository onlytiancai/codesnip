...
export const I18N = {
  ...
  ui: {
    ...
    // 感知机演示 (Perceptron Playground)
    ppTitle:       { zh: "🧪 感知机游乐场",            en: "🧪 Perceptron Playground" },
    ppSubtitle:    { zh: "调节权重 w₁, w₂, b，看决策直线怎么切 4 个点。", en: "Adjust weights w₁, w₂, b and watch the decision line split the 4 points." },
    ppMode:        { zh: "任务",                          en: "Task" },
    ppW1:          { zh: "权重 w₁",                       en: "Weight w₁" },
    ppW2:          { zh: "权重 w₂",                       en: "Weight w₂" },
    ppBias:        { zh: "偏置 b",                        en: "Bias b" },
    ppReset:       { zh: "重置为默认",                    en: "Reset to defaults" },
    ppAccuracy:    { zh: "正确率",                        en: "Accuracy" },
    ppTableInput:  { zh: "输入 (x₁, x₂)",                 en: "Input (x₁, x₂)" },
    ppTableTarget: { zh: "目标 y",                        en: "Target y" },
    ppTableZ:      { zh: "z = w·x + b",                  en: "z = w·x + b" },
    ppTablePred:   { zh: "预测 ŷ",                        en: "Predicted ŷ" },
    ppNoSolution:  { zh: "XOR 不是线性可分的——任何 (w₁, w₂, b) 都无法同时分对 4 个点。", en: "XOR is not linearly separable — no (w₁, w₂, b) can classify all 4 points correctly." },
  },
  quiz: {
