    ...
    def assign():
        ...
        if left:
            ...
            if peek() == '=':
                ...
                right = add()
                if not right:
                    raise Exception('assign: right is none')
...
class MyTests(unittest.TestCase):
    ...
    def test_analyze9(self):
        self.assertEqual(['assign', ['a', '1']], analyze(parse('a=1')))

    def test_analyze10(self):
        self.assertEqual(['prog', [['assign', ['a', '1']], 'a']], analyze(parse('a=1;a')))
