...
[189.6K downloads](https://npm.chart.dev/nuxt-auth-utils)•[1.5K stars](https://github.com/atinux/nuxt-auth-utils)•[v0.5.29](https://github.com/atinux/nuxt-auth-utils/releases)

[![atinux](https://ipx.nuxt.com/f_auto,s_20x20/gh_avatar/atinux)atinux](https://github.com/atinux)

# Nuxt Auth Utils

[![npm version](https://img.shields.io/npm/v/nuxt-auth-utils/latest.svg?style=flat&colorA=020420&colorB=00DC82)](https://npmjs.com/package/nuxt-auth-utils)[![npm downloads](https://img.shields.io/npm/dm/nuxt-auth-utils.svg?style=flat&colorA=020420&colorB=00DC82)](https://npm.chart.dev/nuxt-auth-utils)[![License](https://img.shields.io/npm/l/nuxt-auth-utils.svg?style=flat&colorA=020420&colorB=00DC82)](https://npmjs.com/package/nuxt-auth-utils)[![Nuxt](https://img.shields.io/badge/Nuxt-020420?logo=nuxt.js)](https://nuxt.com)
...
-   [Hybrid Rendering](https://github.com/atinux/nuxt-auth-utils/blob/main/#hybrid-rendering) support (SSR / CSR / SWR / Prerendering)
-   [40+ OAuth Providers](https://github.com/atinux/nuxt-auth-utils/blob/main/#supported-oauth-providers)
-   [Password Hashing](https://github.com/atinux/nuxt-auth-utils/blob/main/#password-hashing)
-   [WebAuthn (passkey)](https://github.com/atinux/nuxt-auth-utils/blob/main/#webauthn-passkey)
-   [`useUserSession()` Vue composable](https://github.com/atinux/nuxt-auth-utils/blob/main/#vue-composable)
-   [Tree-shakable server utils](https://github.com/atinux/nuxt-auth-utils/blob/main/#server-utils)
-   [`<AuthState>` component](https://github.com/atinux/nuxt-auth-utils/blob/main/#authstate-component)
-   [Extendable with hooks](https://github.com/atinux/nuxt-auth-utils/blob/main/#extend-session)
-   [WebSocket support](https://github.com/atinux/nuxt-auth-utils/blob/main/#websocket-support)
...
### [OAuth Event Handlers](#oauth-event-handlers)
...
> !TIP If you want to plug in and use the [Community sourced list of AAGUIDS](https://github.com/passkeydeveloper/passkey-authenticator-aaguids) to decorate your display of added passkeys, you can access the the ID via `credential.aaguid` inside `onSuccess`
...
A full demo can be found on [https://todo-passkeys.nuxt.dev](https://todo-passkeys.nuxt.dev) using [Drizzle ORM](https://orm.drizzle.team/) and [NuxtHub](https://hub.nuxt.com).

The source code of the demo is available on [https://github.com/atinux/todo-passkeys](https://github.com/atinux/todo-passkeys).
...
### [Disable session loading](#disable-session-loading)
